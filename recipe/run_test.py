...
if PPC:
    PYTEST_SKIPS += ["ipython_dir_8", "audio_data", "test_figure_to_svg", "test_figure_to_jpeg", "test_retina_figure", "test_select_figure_formats_kwargs"]

if COV_THRESHOLD is not None:
    PYTEST_ARGS += [
        "--cov", "IPython", "--no-cov-on-fail", COV_THRESHOLD,
